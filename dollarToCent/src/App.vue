<template>
  <div class="container">
    ...
    <div class="button">
      <button @click="calculateMoney()">Hesapla</button>
    </div>
    <div class="result">
      <div class="penny penny1">
        <img
